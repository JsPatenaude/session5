...
public class Server {
	...
	* @param  image on which to apply the filter
	* @return void
	*/
	public void applySobelFilter(/*image*/) {
		
	}
	
	
	// TODO other fct to receive command from client and send command to client
	// TODO manage images (send header and data/buffer --> check most efficient way) to apply filter
